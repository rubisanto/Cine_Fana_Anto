...
--
-- Host: localhost:3306
-- Generation Time: Jun 15, 2022 at 01:42 PM
...
(6, 'Test', '2022-06-13', 'Anto', 'test', 'fim', 'articles-form-code.png');
...
INSERT INTO `forum` (`post_id`, `post_title`, `post_date`, `post_author`, `post_content`) VALUES
(1, 'Post 1', '2022-04-05', 'Thomas', 'Quelques minutes avant de recevoir son premier Oscar, le 27 mars dernier, Will Smith surprend le monde entier. Une blague de mauvais goût adressée à sa femme, Jada Pinkett-Smith, met l’acteur en colère. Il monte sur scène et gifle l’humoriste Chris Rock. Depuis cette soirée, la star hollywoodienne a présenté ses excuses à plusieurs reprises et a démissionné de l’Académie.\r\n\r\nSa carrière commence, elle aussi, à pâtir de ce geste. Certains de ses projets sont notamment mis de côté, dont Fast & Loose, sa nouvelle collaboration avec Netflix. Pour ce film d’action, Will Smith devait jouer sous la direction de David Leitch, le cascadeur de John Wick et réalisateur de Deadpool 2, Atomic Blonde et prochainement de Bullet Train avec Brad Pitt.\r\n\r\nEn phase de développement, le projet faisait déjà briller les yeux des plus grands studios, comme la Warner, la MGM ou encore la Paramount. C’est finalement le géant du streaming qui avait décroché le gros lot.'),
...
(6, 'film préféré', '2022-06-13', 'anto', 'Quel est votre film préféré ? ');
...
INSERT INTO `users` (`user_id`, `user_pseudo`, `user_mail`, `user_adress`, `user_date_of_birth`, `user_first_name`, `user_last_name`, `user_password`, `user_role`) VALUES
(1, 'admin', 'admin@test.fr', 'admin', '1996-06-06', 'admin', 'admin', 'admin', 'admin'),
(2, 'admintest', 'admintest@test.fr', 'admintest', '1996-06-06', 'admintest', 'admintest', '$2y$10$UU39VJN1NhrSnQkySNVB6OuYvPZjGNUEA/FHNl48nlmMPssPsgdTe', 'user'),
(3, 'Anto', 'antoinegogce@hotmail.fr', 'adresse', '1996-06-06', 'Antoine', 'Gogce', '$2y$10$5whCwIaUvR3EPIyoUCoYIOg6dAj8Ia0afLyQBUkTdJqyICIOIwD7m', 'admin');
